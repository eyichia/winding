...
################################################################################
## Form generated from reading UI file 'arrange0309.ui'
##
...
class Ui_Arrange(object):
    def setupUi(self, Arrange):
        ...
        self.file_export_A = QAction(Arrange)
        self.file_export_A.setObjectName(u"file_export_A")
        self.file_export_B = QAction(Arrange)
        self.file_export_B.setObjectName(u"file_export_B")
        self.file_export_C = QAction(Arrange)
        self.file_export_C.setObjectName(u"file_export_C")
        ...
        self.file_opencsv = QAction(Arrange)
        self.file_opencsv.setObjectName(u"file_opencsv")
...
"}")
        ...
        self.lb_pa_005.setGeometry(QRect(35, 530, 60, 30))
        self.lb_pa_005.setMaximumSize(QSize(16777215, 16777215))
        self.lb_pa_005.setFont(font)
        ...
        self.label_6.setGeometry(QRect(35, 495, 60, 30))
        ...
        self.label_7.setGeometry(QRect(35, 565, 60, 30))
        ...
        self.label_8.setGeometry(QRect(35, 600, 60, 30))
...
"}")
        ...
        self.label_3.setGeometry(QRect(100, 445, 205, 25))
        ...
        self.label_4.setGeometry(QRect(100, 470, 100, 25))
        ...
        self.label_5.setGeometry(QRect(207, 470, 100, 25))
        ...
        self.PB_Calculate.setFont(font1)
...
"}")
        ...
        self.Cross_sectional_area.setFont(font)
...
"}")
        ...
        self.Coordinate_AX.setFont(font)
...
"}")
        ...
        self.Coordinate_CX.setFont(font)
...
"}")
        ...
        self.Coordinate_AY.setFont(font)
...
"}")
        ...
        self.Coordinate_CY.setFont(font)
...
"}")
        ...
        self.Coordinate_DX.setFont(font)
...
"}")
        ...
        self.Coordinate_DY.setFont(font)
...
"}")
        ...
        self.Process.setGeometry(QRect(395, 345, 270, 320))
...
"}")
        ...
        self.line.setGeometry(QRect(390, 335, 310, 2))
        ...
        self.PB_Clear_process.setGeometry(QRect(515, 675, 150, 40))
        ...
        self.PB_Clear_process.setFont(font1)
...
"}")
        ...
        self.label_9.setGeometry(QRect(390, 245, 190, 30))
        ...
        self.Slot_fill_rate.setFont(font)
...
"}")
        ...
        self.Export.addAction(self.file_export_A)
        self.Export.addAction(self.file_export_B)
        self.Export.addAction(self.file_export_C)
        self.Save.addAction(self.file_save_csv)
        self.Save.addAction(self.file_save_txt)
        self.Open.addAction(self.file_opencsv)
    ...
    def retranslateUi(self, Arrange):
        ...
        self.file_exit.setShortcut(QCoreApplication.translate("Arrange", u"Ctrl+X", None))
#endif // QT_CONFIG(shortcut)
        self.file_export_A.setText(QCoreApplication.translate("Arrange", u"Type A", None))
        self.file_export_B.setText(QCoreApplication.translate("Arrange", u"Type B", None))
        self.file_export_C.setText(QCoreApplication.translate("Arrange", u"Type C", None))
        self.about_version.setText(QCoreApplication.translate("Arrange", u"\u7248\u672c(&V)", None))
#if QT_CONFIG(shortcut)
        self.about_version.setShortcut(QCoreApplication.translate("Arrange", u"Ctrl+V", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.file_opencsv.setText(QCoreApplication.translate("Arrange", u"CSV(\u9017\u865f\u5206\u9694)(*.csv)", None))
        ...
        self.label_6.setText(QCoreApplication.translate("Arrange", u"A", None))
        self.label_7.setText(QCoreApplication.translate("Arrange", u"C", None))
        self.label_8.setText(QCoreApplication.translate("Arrange", u"D", None))
        self.label_3.setText(QCoreApplication.translate("Arrange", u"Coordinate", None))
        self.label_4.setText(QCoreApplication.translate("Arrange", u"X", None))
        self.label_5.setText(QCoreApplication.translate("Arrange", u"Y", None))
        ...
        self.label_9.setText(QCoreApplication.translate("Arrange", u"Slot fill rate", None))
        self.File.setTitle(QCoreApplication.translate("Arrange", u"\u6a94\u6848", None))
        self.Export.setTitle(QCoreApplication.translate("Arrange", u"\u532f\u51fa\u7d50\u679c(*.csv)", None))
